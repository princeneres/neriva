...
- Parallel agent work uses one git worktree per feature. Remove the worktree and its branch after the merge; stale worktrees under `.Codex/worktrees/` carry a full `node_modules` each.
