...
import { IconDatabase, IconPencil, IconPlus, IconTable, IconTrash } from '@tabler/icons-react';
        ...
        {showEmptyState ? (
          <Stack align="center" gap="sm" py={56} px="md">
            ...
            <Text c="slate.5" ta="center" maw={420}>
              Objects are your own data tables, like Products or Leads. Define the columns once and
              start adding records, no code needed.
            </Text>
            <Button component={Link} href="/admin/objects/new" leftSection={<IconPlus size={16} />}>
              New object
            </Button>
